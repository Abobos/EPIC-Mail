...
(0, _mocha.describe)('POST /signup', function () {
  ...
  (0, _mocha.it)('should return a status of 400 , when firstname is invalid', function (done) {
    _chai.default.request(_app.default).post('/api/v1/auth/signup').send({
      lastname: 'Obiamata',
      email: 'elohorobiamata@gmail.com',
      password: '321234',
  ...
  (0, _mocha.it)('should return a status of 400 , when password is invalid', function (done) {
    _chai.default.request(_app.default).post('/api/v1/auth/signup').send({
      firstname: 'Elohor',
      lastname: 'Obiamata',
      email: 'elohorobiamata@gmail.com',
...
(0, _mocha.describe)('POST /login', function () {
  ...
  (0, _mocha.it)('should return a status of 400 when user email is invalid', function (done) {
    _chai.default.request(_app.default).post('/api/v1/auth/login').send({
      password: '321234'
    }).end(function (req, res) {
      res.should.have.status(400);
